<section class="single-blog-area">
    ...
    <div class="container simply-box-container">
        <?php echo $this->Html->link('Powrót', array('controller' => 'pages', 'action' => 'diet'), array('class' => 'btn-green btn-back')); ?>
        ...
        <div class="simply-box">
            <div class="simple-inner-container">
                ...
                <div class="col-sm-12 single-article">
                    ...
                    <h5 class="tx-hand pull-right article-date"><?php echo date('d.m.Y', strtotime($diet['Diet']['created'])); ?></h5>
                        ...
                        <div class="col-xs-12 col-sm-12 article-info">
                            ...
                            <div class="article-description">
                                <div class="article-image">
                                    <?php echo $this->Media->embed('t' . DS . $diet['Diet']['dirname'] . DS .$diet['Diet']['basename'], array('height' => '', 'width' => '', 'class' => 'article-image')); ?>
                                </div>
