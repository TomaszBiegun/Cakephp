...
<?php echo $this->Form->create('Quiz'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Quiz'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Quiz.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Quiz.id')))); ?></li>
