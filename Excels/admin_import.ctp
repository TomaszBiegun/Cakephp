        ...
        <div class="col-xs-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Zaimportuj plik z produktami</h3>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <div class="templateView">
                                ...
                                <?php echo $this->Html->image('template.jpg', array('id' => 'templatePhoto')); ?>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            ...
                            <div class="templateDownload">
                                <?php echo $this->Html->link('Pobierz', array('admin' => true, 'controller' => 'excels', 'action' => 'download'), array('class' => 'btn btn-success')) ?>
                            </div>
                        </div>
                    </div>
                ...
                <h4>Skoroszyt produktów musi być na pierwszej pozycji w pliku .xlsx</h4>
                ...
                <div class="box-footer">
                    <?php echo $this->Html->link('Opróżnij bazę produktów', array('admin' => true, 'controller' => 'excels', 'action' => 'turncate'), array('class' => 'btn btn-danger')) ?>
                </div>
...
<div class="myShadow">
    <div class="main-shadow-photo">
        <?php echo $this->Html->image('template.jpg', array('style' => 'display:none;', 'id' => 'bigTemplate')); ?>
    </div>
