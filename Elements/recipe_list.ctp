<div id="place-<?php echo $key; ?>" class="col-sm-12 single-food"
     data-iterator="<?php echo $key; ?>">
    <div class="diet-custom-container">
        <h1 class="tx-hand simple-title pull-left">
            <?php
            if ($recipe['Recipe']['type'] == 'śniadanie2') {
                echo 'II ŚNIADANIE';
            } else {
                echo ucfirst($recipe['Recipe']['type']);
            } ?>
        </h1>

        <div class="row food-row">
            <div class="col-xs-12  col-sm-3 food-image">
                <?php echo $this->Html->image('../odczyt/' . $recipe['Recipe']['basename'], array('width' => '', 'height' => '')); ?>
            </div>
            <div class="col-xs-12 col-sm-9 food-info">
                <div class="food-rating">

                    <div class="stars starrr"
                         data-rating="<?php echo $recipe['Recipe']['mark']; ?> "
                         data-id="<?php echo $recipe['Recipe']['id']; ?> "
                         data-vote="denied"></div>


                    <h5 class="rating-info" id="info-<?php echo $recipe['Recipe']['id']; ?>">
                        Ocena <?php echo $recipe['Recipe']['mark']; ?> /5</h5>
                </div>
                <div class="food-title">
                    <a href="/pages/meal/<?php echo $recipe['Recipe']['id']; ?>"><h3
                            class="tx-hand"><?php echo $recipe['Recipe']['name']; ?></h3></a>
                </div>

                <a href="" data-id="<?php echo $recipe['Recipe']['id']; ?>"
                   data-type="<?php echo $recipe['Recipe']['type']; ?>"
                   class="btn-green green-submit btn-change-meal" data-toggle="modal"
                   data-target="#changeModal">Zmień</a>
