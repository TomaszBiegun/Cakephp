...
<section class="shop-area">
    <div class="add-info box">
        ...
        <img src="../img/icons/shop-bag-icon2.png">
    </div>
    ...
    <div class="black-heading shop-heading">
        <div class="tx-holder">
            ...
            <h2 class="tx-hand tx-subtitle">
                Pokaż , że jesz razem z GreenCook!
            </h2>
        </div>
            ...
            <div class="simple-inner-container">
                ...
                <div class="row shop-row">
                    <?php foreach ($items as $key => $item): ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 shop-item">
                            <div class="col-sm-4 item-photo">
                                <?php echo $this->Media->embed('t' . DS . $item['Item']['dirname'] . DS . $item['Item']['basename'], array('height' => '', 'width' => '', 'class' => 'img-responsive')); ?>

                            </div>
                            <div class="col-sm-8 item-info">
                                <div class="item-heading">
                                    <a href="/items/view/<?php echo $item['Item']['id']; ?>">
                            ...
                            <div class="col-sm-12 item-actions">
                                <div class="col-xs-12 col-sm-6 single-action">
                                ...
                                <div class="col-xs-12 col-sm-6 single-action">
                                    <a class="btn-green btn-buy" href="/items/view/<?php echo $item['Item']['id']; ?>">Więcej</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
